  ...
  const handleExport = async () => {
    ...
    try {
      ...
      sheet.columns = [
        ...
        { header: 'AFP/ONP', key: 'pension_name', width: 22 }, // Ancho ajustado para mostrar "AFP Integra (M)"
      ...
      payrollData.forEach((item, index) => {
        ...
        const row = sheet.addRow({
          ...
          pension_name: d.pensionName, // Incluye el tipo (M)/(F)
        ...
        row.eachCell((cell, colNumber) => {
          ...
          if (colNumber === 5 || colNumber === 11 || colNumber === 13 || colNumber === 16) {
          ...
          if (colNumber === 21) {
              cell.font = { bold: true, color: { argb: '006600' } };
          }
        });
      });
      ...
      totalRowArray[2] = 'TOTAL GENERAL'; 
      totalRowArray[14] = totalIncome;    
      totalRowArray[20] = totalNet;       
      totalRowArray[21] = totalEssalud;   
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
        ...
        >
          <div className="bg-[#003366] p-6 text-white text-center relative">
            ...
            <div className="bg-white/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 backdrop-blur-md"><FileSpreadsheet size={32} /></div>
          ...
          <div className="p-6 space-y-6">
            ...
            {(!payrollData || payrollData.length === 0) && (
                <div className="flex items-start gap-3 p-4 bg-orange-50 text-orange-700 rounded-xl text-sm border border-orange-100">
                    ...
                    <p>No hay datos calculados. Presiona <b>"Calcular"</b> antes de exportar.</p>
                </div>
            )}
