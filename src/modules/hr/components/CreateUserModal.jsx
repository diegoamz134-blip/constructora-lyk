...
const CreateUserModal = ({ isOpen, onClose, activeTab, onSuccess, userToEdit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (activeTab === 'staff') {
        // Lógica para Staff (Mantiene Contrato)
        ...
        // Lógica para Obreros (Sin Contrato)
        ...
        // Eliminado: payload.contract_end_date 
      }
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className={`space-y-1 ${activeTab !== 'staff' ? 'col-span-2' : ''}`}>
