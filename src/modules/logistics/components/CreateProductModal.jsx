  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Error',
        text: 'No se pudo crear el producto. Inténtelo de nuevo.',
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-300 border border-white/20">
          ...
          <div className="relative z-10 flex justify-between items-start">
            <div>
              ...
              <p className="text-blue-100 text-sm mt-1 font-medium opacity-90">
                Registrar ítem en el Catálogo Maestro
              </p>
            </div>
            <button 
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input 
                type="text" 
                required
                className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-700 font-medium outline-none focus:bg-white focus:border-[#003366] focus:ring-4 focus:ring-[#003366]/10 transition-all placeholder:text-slate-400"
                placeholder="Ej: Cemento Sol Tipo I"
                value={formData.name}
          ...
          <div className="grid grid-cols-2 gap-5">
             ...
             <div className="space-y-2">
                <label className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1 text-red-400">
                  Alerta Mínima
                </label>
                <div className="relative group">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-red-300 group-focus-within:text-red-500 transition-colors">
                    <AlertCircle size={18} />
                  </div>
                  <input 
                    type="number" 
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input 
                type="text" 
                className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-700 font-medium outline-none focus:bg-white focus:border-[#003366] focus:ring-4 focus:ring-[#003366]/10 transition-all placeholder:text-slate-400"
                placeholder="Ej: Pasillo 3, Estante B-12"
          ...
          <div className="pt-6 mt-2 border-t border-slate-100 flex gap-3 justify-end">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="px-8 py-3 bg-[#003366] hover:bg-[#002244] text-white font-bold rounded-xl shadow-lg shadow-blue-900/20 hover:shadow-blue-900/40 transition-all flex items-center gap-2 transform active:scale-95 disabled:opacity-70 disabled:pointer-events-none text-sm"
            >
              {loading ? (
