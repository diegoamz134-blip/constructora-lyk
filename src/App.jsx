...
const WorkerProfilePage = React.lazy(() => import('./modules/worker/WorkerProfilePage')); // <--- NUEVO IMPORT
    ...
    <Suspense fallback={<LoadingSpinner />}>
      <Routes>
        ...
        <Route path="/worker" element={<WorkerLayout />}>
          ...
          <Route path="profile" element={<WorkerProfilePage />} /> {/* <--- RUTA FALTANTE AGREGADA */}
        </Route>
